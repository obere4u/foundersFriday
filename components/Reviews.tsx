...
export default function Reviews() {
  ...
  return (
    <MaxWidthWrapper>
      <section className="px-4 md:pl-20">
        <div className="flex flex-col items-center md:flex-row md:items-center md:justify-between md:pl-40">
          <div className="flex flex-col space-y-5 items-center w-full text-center">
            <h2 className="capitalize font-bold text-[1.875rem] md:text-[2.5rem] leading-[1.5] text-black">
          ...
          <div className="flex items-center space-x-5 md:space-x-[30px] mt-8 md:mt-0">
            <button
              onClick={handlePrev}
              className="rounded-full border-[3px] border-[#E2A7F7] flex items-center justify-center p-4 md:p-[18.52px]"
            >
              <ArrowLeft
                size={36}
                stroke="#000000"
            ...
            <button
              onClick={handleNext}
              className="rounded-full flex items-center justify-center border-[3px] border-[#E2A7F7] p-4 md:p-[18.52px]"
            >
              <ArrowRight
                size={36}
                stroke="#000000"
        ...
        <div className="mt-10 flex justify-center">
          <div className="max-w-full md:max-w-[414px] flex flex-col items-center justify-center text-center">
            <div className="bg-transparent border-[3px] border-[#8300FF] flex items-center justify-center rounded-full w-[110px] h-[110px] md:w-[138px] md:h-[138px]">
              <div className="w-[90px] h-[90px] md:w-[110.4px] md:h-[110.4px] rounded-full">
                <Image
                  ...
                  width={110.4}
                  height={110.4}
                  alt={`Picture of ${reviews[activeIndex].reviewer}`}
