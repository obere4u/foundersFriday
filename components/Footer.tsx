  ...
  return (
    <footer className="mt-auto pt-5 border-t border-[#75687E]">
      <MaxWidthWrapper>
        ...
        <div className="w-[1045px] mt-20 mx-auto flex flex-col items-center justify-center space-y-10">
          <p className="capitalize text-center font-bold text-[2.65rem] leading-[56.25px] text-black">
        ...
        <div className="mt-40 pt-10 border-t border-[#75687E] flex items-center justify-between">
